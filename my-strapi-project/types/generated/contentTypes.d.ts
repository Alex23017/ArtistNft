...
export interface ApiArtsCardArtsCard extends Struct.CollectionTypeSchema {
  collectionName: 'arts_cards';
  info: {
    displayName: 'ArtsCard';
    pluralName: 'arts-cards';
    singularName: 'arts-card';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    bigSize: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    img: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::arts-card.arts-card'> &
      Schema.Attribute.Private;
...
export interface ApiHomeNftHomeNft extends Struct.CollectionTypeSchema {
  collectionName: 'home_nfts';
  info: {
    displayName: 'HomeNft';
    pluralName: 'home-nfts';
    singularName: 'home-nft';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    imgArts: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home-nft.home-nft'>;
    price: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiPricingPricing extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    textThree: Schema.Attribute.String;
